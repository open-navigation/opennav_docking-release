...
Name:           ros-humble-opennav-docking
Version:        0.0.2
Release:        4%{?dist}%{?release_suffix}
Summary:        ROS opennav_docking package
...
Requires:       ros-humble-nav2-graceful-controller
Requires:       ros-humble-nav2-msgs
Requires:       ros-humble-nav2-util
Requires:       ros-humble-opennav-docking-core
Requires:       ros-humble-opennav-docking-msgs
...
BuildRequires:  ros-humble-nav2-graceful-controller
BuildRequires:  ros-humble-nav2-msgs
BuildRequires:  ros-humble-nav2-util
BuildRequires:  ros-humble-opennav-docking-core
BuildRequires:  ros-humble-opennav-docking-msgs
...
%changelog
* Wed Jun 05 2024 Steve Macenski <steve@opennav.org> - 0.0.2-4
