...
Name:           ros-humble-opennav-docking-bt
Version:        0.0.2
Release:        4%{?dist}%{?release_suffix}
Summary:        ROS opennav_docking_bt package

License:        Apache-2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-behaviortree-cpp-v3
...
BuildRequires:  ros-humble-behaviortree-cpp-v3
